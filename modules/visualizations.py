...
def plot_gex_profile(gex_df, spot_price, gamma_levels):
    ...
    fig.add_trace(go.Bar(
        x=gex_df['strike'], y=gex_df['call_gex']/1e7, name='Call GEX', 
        marker_color='rgba(239,68,68,0.7)', 
        hovertemplate='<b>Strike:</b> %{x}<br><b>Call GEX (Cr.):</b> %{y:.2f}<extra></extra>'
    ))
    fig.add_trace(go.Bar(
        x=gex_df['strike'], y=gex_df['put_gex']/1e7, name='Put GEX', 
        marker_color='rgba(34,197,94,0.7)', 
        hovertemplate='<b>Strike:</b> %{x}<br><b>Put GEX (Cr.):</b> %{y:.2f}<extra></extra>'
    ))
    ...
    fig.add_trace(go.Scatter(
        ...
        mode="lines",
        name="Call OI (L)",
        line=dict(color="rgb(47, 49, 181)", width=1, dash="solid"),
    ...
    fig.add_trace(go.Scatter(
        ...
        mode="lines",
        name="Put OI (L)",
        line=dict(color="rgb(42,42,0)", width=1, dash="solid"),
